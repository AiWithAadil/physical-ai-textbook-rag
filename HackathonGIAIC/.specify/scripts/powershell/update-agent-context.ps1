...
Mirrors the behavior of scripts/bash/update-agent-context.sh:
 ...
 5. Multi-Agent Support (claude, openrouter, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, roo, amp, q)
...
param(
    ...
    [ValidateSet('claude','openrouter','copilot','cursor-agent','qwen','opencode','codex','windsurf','kilocode','auggie','roo','codebuddy','amp','q')]
    [string]$AgentType
)
...
function Print-Summary {
    ...
    Write-Host ''
    Write-Info 'Usage: ./update-agent-context.ps1 [-AgentType claude|openrouter|copilot|cursor-agent|qwen|opencode|codex|windsurf|kilocode|auggie|roo|codebuddy|amp|q]'
}
